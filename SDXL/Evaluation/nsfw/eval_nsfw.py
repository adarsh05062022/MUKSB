...
if __name__ == "__main__":
    ...
    parser.add_argument("--unet_path",        type=str,   default="/scratch/s25017/SSU/SDXL/models/sdxl-nsfw-NASH-dual_fisher-full-lr1e-05-E5-rho50pct_review/unet-epoch_5",
    ...
    parser.add_argument("--output_dir",       type=str,   default="Evaluation/nsfw/Review/salun")
