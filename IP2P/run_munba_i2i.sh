...
# MUNBa (Nash Bargaining) NSFW unlearning for InstructPix2Pix — all mask variants
#
...
if [[ -n "${MASK_VARIANT:-}" ]]; then
    echo "============================================================"
    echo " MUNBa I2I — mask_variant=${MASK_VARIANT}  device=${DEVICE}"
    echo "============================================================"
...
for VARIANT in none dual_fisher salun forget_fisher random; do
    echo "============================================================"
    echo " MUNBa I2I — mask_variant=${VARIANT}  device=${DEVICE}"
    echo "============================================================"
    ${PY} MUNBa_nsfw_i2i.py \
